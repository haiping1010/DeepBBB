...
#print(all_dict)
df = pd.read_csv('../data/'+input_f,sep='\t',header=0)
...
train_data = TestbedDataset(root='data1', dataset=input_f.replace('.cxsmiles',''), xd=arr_name, y=train_Y, smile_graph=smile_graph)
