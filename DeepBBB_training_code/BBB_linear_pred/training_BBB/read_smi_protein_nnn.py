...
with open('B3DB_regression_dict.json', 'r') as f:
...
train_data_pos = TestbedDataset(root='data1', dataset='B3DB_regression', xd=arr_name_pos, y=train_Y_pos, smile_graph=smile_graph)
