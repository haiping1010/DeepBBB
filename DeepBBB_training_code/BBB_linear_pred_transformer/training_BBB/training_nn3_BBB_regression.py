...
dataset_pos=TestbedDataset2(root='data1', dataset='B3DB_regression')

print ('alldata len:',dataset_pos.__len__())
#35080
train_dataset_pos, val_dataset_pos = random_split(dataset_pos, (1000, 51))



dataset_train_all=train_dataset_pos
dataset_test_all=val_dataset_pos
