...
train_dataset_pos_n=train_dataset_pos + train_dataset_pos + train_dataset_pos
...
train_dataset_neg, val_dataset_neg = random_split(dataset_neg, (12500, 421))

dataset_train_all=train_dataset_pos_n+train_dataset_neg
dataset_test_all=val_dataset_pos +  val_dataset_neg
